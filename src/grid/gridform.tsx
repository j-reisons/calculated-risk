...
import { GridFormState, GridState, logRange } from './state';
...
export const GridForm = ({ setGridState }: GridFormProps) => {
    ...
    return (
        <div>
            ...
            <div>Wealth step <input type="text" inputMode="numeric" value={gridFormState.wealthStep} onChange={handleInput} onBlur={onBlur} id="wealthStep" name="wealthStep" pattern="^\d+(\.\d+)?%$" /></div>
